...
import Tabela from './app/shared/componentes/Tabela.vue';
import Detalhe from './app/shared/componentes/Detalhe.vue';
import Status from './app/shared/componentes/Status.vue';
import ErroBox from './app/shared/componentes/ErroBox.vue';
import MsgBox from './app/shared/componentes/MsgBox.vue';

//Bibliotecas Customizadas
import masker from './app/shared/libs/mask/masker';
import cpfMasker from './app/shared/libs/mask/cpfMasker';
import cnpjMasker from './app/shared/libs/mask/cnpjMasker';
import telefoneMasker from './app/shared/libs/mask/telefoneMasker';
import cepMasker from './app/shared/libs/mask/cepMasker';
import dateFormat from './app/shared/libs/dateHelper';
import { validarCPF } from './app/shared/libs/cpf';
//import './app/shared/libs/textoHelpers';
...
app.config.globalProperties.$cpfMasker = cpfMasker;
app.config.globalProperties.$cnpjMasker = cnpjMasker;
app.config.globalProperties.$telefoneMasker = telefoneMasker;
app.config.globalProperties.$cepMasker = cepMasker;
app.config.globalProperties.$validarCPF = validarCPF;
app.config.globalProperties.$dateFormat = dateFormat;
app.config.globalProperties.$numeral = numeral;
app.config.globalProperties.$moment = moment;
app.config.globalProperties.$formatter = new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL', })
